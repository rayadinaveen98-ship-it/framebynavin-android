...
/** Capture the live app so the guide overlay can blur only the non-target area. */
@Composable
...
/** Strong focus treatment: blurred + dimmed surroundings, completely clear selected target. */
@Composable
