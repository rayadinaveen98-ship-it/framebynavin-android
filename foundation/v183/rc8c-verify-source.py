...
stage={P,'foundation/v183/rc8c-client-contract.md','foundation/v183/rc8c-verify-source.py','.github/workflows/v183-server-lifecycle-client.yml'}
...
print('Exact RC8c source, nine-file scope, version, and lifecycle contracts verified')
